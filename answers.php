...
while($aaa=mysqli_fetch_assoc($aa)){
	...
	$questionid=$_SESSION['ans'];
	//$ans=mysqli_real_escape_string($conn,$_POST['ans']);
	$_SESSION['answ']=$questionid;
	echo "<form action='ans.php' method='post'><textarea name='answerr' rows='5' cols='40'></textarea><input type='submit' value='Post Answer'></form>";
}
?>
  </div>
</div>
