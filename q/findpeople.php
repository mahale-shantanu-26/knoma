...
echo "<h3 style='font-family:cambria;'>People you may know</h3><hr><br>";
 $i=1;
$r="SELECT * FROM users";
...
while($rrr = mysqli_fetch_assoc($rr)){
        ...
        <font face = 'Cambria'>is a $qq <form action='findpeople.php' method='POST'>
        ...
        if(isset($_POST[$ii])){
            ...
            //echo "<a href='details.php?var=$ii' style='text-decoration:none'>&nbsp;$pp&nbsp;&nbsp;&nbsp;Occupation:$qq<br></a>
	        echo "<br>";
      $i++;
