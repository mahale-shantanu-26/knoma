...
<div class="rightcolumn">
  <div class="card">
  <?php
$na=$_SESSION['fol_page_name'];
$ii=$_SESSION['foll_page'];
$id=$_SESSION['user_id'];
$sql1="INSERT INTO f_pages (user_id,page_id) VALUES ('$id','$ii')";
$query1 = mysqli_query($conn,$sql1);
if($query1>0){
	echo "<h3 style='font-family:cambria;'>You started following ".$na." </h3><hr><br>";
}
else{
    echo "<h3 style='font-family:cambria;'>You are already following ".$na." </h3><hr><br>";
}
