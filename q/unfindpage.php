...
<div class="rightcolumn">
  <div class="card">
  <?php
$na=$_SESSION['unfol_page_name'];
$ii=$_SESSION['unfoll_page'];
$id=$_SESSION['user_id'];
$sql="DELETE FROM f_pages WHERE user_id='$id' AND page_id='$ii'";
$query = mysqli_query($conn,$sql);
if($query>0){
    echo "<h3 style='font-family:cambria;'>You unfollowed ".$na." </h3>
    <form action='followingpages.php' method='POST'>
        <input type=submit name=$ii class='buttonz button1' value=BACK style='font-family:Cambria; font-size:15px; float:right;'>
		</form><br><br><br>
    <hr><br>";
}
