...
$id=$_SESSION['user_id'];
$bd=mysqli_real_escape_string($conn,$_POST['c7']);
if($bd){
    $sql = "UPDATE users SET birthdate='$bd' WHERE user_id ='$id' ";
    mysqli_query($conn,$sql);
    $_SESSION['user_birthdate']=$bd;
    echo "<h4 style='font-family:cambria;'>Your birthdate has been changed! </h4>";
}
