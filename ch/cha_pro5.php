...
$id=$_SESSION['user_id'];
$mob=mysqli_real_escape_string($conn,$_POST['c5']);
if($mob){
    $sql = "UPDATE users SET phone_number='$mob' WHERE user_id ='$id' ";
    mysqli_query($conn,$sql);
    $_SESSION['user_mobile']=$mob;
    echo "<h4 style='font-family:cambria;'>Your mobile number has been changed! </h4>";
}
