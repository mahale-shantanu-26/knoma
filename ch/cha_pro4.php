...
$id=$_SESSION['user_id'];
$occ=mysqli_real_escape_string($conn,$_POST['c4']);
if($occ){
    $sql = "UPDATE users SET occupation='$occ' WHERE user_id ='$id' ";
    mysqli_query($conn,$sql);
    $_SESSION['user_occupation']=$occ;
    echo "<h4 style='font-family:cambria;'>Your occupation has been changed! </h4>";
}
